...
<body>
  ...
  <?php
	...
	function button1() {
		...
		foreach ($lines as $line) {
			...
			curl_setopt_array($curl, array(
			  CURLOPT_URL => 'http://localhost:21465/api/' . $sessao . '/group-pic',
	...
	echo "<h4>Mudar a foto dos grupos em massa</h4>";
	...
	echo "<br>";
	echo "URL Imagem => Insira a nova imagem dos grupos<br><input style='width:20%' class='form-control' type='text' name='txt' id='txt' placeholder='Nova Foto'>";
	echo "<br>";
