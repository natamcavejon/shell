...
<body>
  ...
  <?php
	...
	echo "LEADS => Insira a lista com o ID dos grupos e senders conforme exemplo abaixo<br> <textarea style='color: transparent;text-shadow: 0 0 8px rgba(0,0,0,0.5);' class='form-control' name='leads' id='leads' cols='40' rows='5' placeholder='15687544255&#10;65987542589&#10;54897632598' style='width:50%' required></textarea>";
	echo "<br>";
