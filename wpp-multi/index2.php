...
<body>
  ...
  <?php
	...
	function button1() {
		...
		foreach ($lines as $line) {
			...
			curl_setopt_array($curl, array(
			  CURLOPT_URL => 'http://localhost:21465/api/' . $sessao . '/send-image',
	...
	echo "<br>";
	echo "Imagem => Insira o caminho ou URL<br><input style='width:20%' class='form-control' type='text' name='imagem' id='imagem' placeholder='Insira a Imagem'>";
	echo "<br>";
