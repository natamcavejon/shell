...
<body>
  ...
  <?php
	...
	function button1() {
		...
		foreach ($lines as $line) {
			...
			curl_setopt_array($curl, array(
			  CURLOPT_URL => 'http://localhost:21465/api/' . $sessao . '/send-voice-base64',
	...
	echo "<br>";
	echo "MP3 => Insira a URL do arquivo MP3<br><input style='width:20%' class='form-control' type='text' name='link' id='link' placeholder='Insira a URL do arquivo MP3'>";
	echo "<br>";
