...
<body>
  ...
  <?php
	...
	function button1() {
		...
		foreach ($lines as $line) {
			...
			curl_setopt_array($curl, array(
			  CURLOPT_URL => 'http://localhost:21465/api/' . $sessao . '/remove-participant-group',
	...
	echo "<h4>Remover participante</h4>";
	...
	echo "<br>";
	echo "User => Insira o usuário<br><input style='width:20%' class='form-control' type='text' name='txt' id='txt' placeholder='5511912345678'>";
	echo "<br>";
