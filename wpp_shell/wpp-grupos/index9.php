...
<body>
  ...
  <?php
	...
	//echo $groupCheck;
	function button1() {
		if(isset($_POST['groupCheck']) && $_POST['groupCheck'] == "groupCheck"){ //where "Value" is the
		...
		foreach ($lines as $line) {
			...
			curl_setopt_array($curl, array(
			  CURLOPT_URL => 'http://localhost:21465/api/' . $sessao . '/messages-admins-only',
	...
	echo "<h4>Configuração do Grupo</h4>";
	...
	echo "<br>";
	echo "<input type='checkbox' id='groupCheck' name='groupCheck' value='groupCheck'>";
	echo "<label for='groupCheck'>Apenas admins falam</label><br>";
	echo "<br>";
