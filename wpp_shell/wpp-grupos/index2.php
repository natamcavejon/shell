...
<body>
  ...
  <?php
	...
	function button1() {
		...
		foreach ($lines as $line) {
			...
			curl_setopt_array($curl, array(
			  CURLOPT_URL => 'http://localhost:21465/api/' . $sessao . '/group-subject',
	...
	echo "<h4>Mudar o título dos grupos em massa</h4>";
	...
	echo "<br>";
	echo "Título => Insira o novo título<br><input style='width:20%' class='form-control' type='text' name='txt' id='txt' placeholder='Novo Título'>";
	echo "<br>";
