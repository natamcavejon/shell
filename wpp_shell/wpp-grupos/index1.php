...
<body>
  ...
  <?php
	...
	function button1() {
		...
		foreach ($lines as $line) {
			...
			curl_setopt_array($curl, array(
			  CURLOPT_URL => 'http://localhost:21465/api/' . $sessao . '/create-group',
	...
	echo "<h4>Criar grupos em massa</h4>";
	echo "Nome dos Grupos => Insira a lista com o nome dos grupos<br> <textarea class='form-control' name='groups' id='groups' cols='40' rows='5' placeholder='Grupo 001&#10;Grupo 002&#10;Grupo 003' style='width:50%' required></textarea>";
	echo "<br>";
	echo "Participante => Insira um participante<br><input style='width:20%' class='form-control' type='text' name='participante' id='participante' placeholder='5511912346578'>";
	echo "<br>";
	...
	echo "<br>";
	echo "<input class='btn btn-success'type='submit' name='button1' class='button' value='Criar Grupos' />";
	echo "<br>";
	echo "<br>";
	echo "<hr>";
	echo "</form>";
