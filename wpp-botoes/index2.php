...
<body>
  ...
  <?php
	...
	echo "<h4>Envio de botões URL</h4>";
	...
	echo "<br>";
	echo "URL Botão => Insira a URL do botão<br><input style='width:20%' class='form-control' type='text' name='urlbtn' id='urlbtn' placeholder='Insira a URL'>";
	echo "<br>";
